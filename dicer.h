...
//void print_csv_row(FILE *val, struct pqos_mon_data *val2, const double mbr, const double mbl);
void free_space(void);
void print_results_to_csv(FILE *val2, char *val3, const pid_t val4, int val1, struct pqos_event_values *val);
